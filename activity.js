...
function showActivityDetail(activityId) {
    ...
    // Set activity title with date
    const titleElement = document.getElementById('activity-detail-name');
    titleElement.innerHTML = `
        <span class="activity-title-text">${activityInfo.title}</span>
        <span class="activity-title-date">${activityInfo.date}</span>
    `;
    ...
    detailContent.innerHTML = `
        ...
        <div class="activity-detail-actions">
            <a href="${activityInfo.url}" target="_blank" rel="noopener noreferrer" class="activity-url-button">
                View Original News
