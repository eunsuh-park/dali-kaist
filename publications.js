...
function createPublicationCard(pub) {
    ...
    img.src = 'images/members/jeong-nam_kim.jpg';
    ...
    // Create hover overlay with icon button
    const pdfUrl = pub.URL || pub.URL2 || pub.URL3 || '';
    if (pdfUrl) {
        const overlay = document.createElement('div');
        overlay.className = 'publication-card-overlay';
        
        const iconContainer = document.createElement('div');
        iconContainer.className = 'publication-icon-container';
        
        const iconButton = document.createElement('a');
        iconButton.href = pdfUrl;
        iconButton.className = 'publication-icon-button';
        iconButton.target = '_blank';
        iconButton.rel = 'noopener noreferrer';
        iconButton.setAttribute('aria-label', 'View Publication');
        ...
        label.className = 'publication-icon-label';
        label.textContent = 'ResearchGate';
